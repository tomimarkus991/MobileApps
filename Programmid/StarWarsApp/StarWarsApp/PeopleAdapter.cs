...
namespace StarWarsApp
{
    ...
    {
        List<People.People> _items;
        Activity _context;
        public WeatherAdapter(Activity context, List<People.People> items) : base()
        {
            _items = items;
            _context = context;
        }
        public override People.People this[int position]
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null)
            {
                view = _context.LayoutInflater.Inflate(Resource.Layout.people_row, null);
            }
